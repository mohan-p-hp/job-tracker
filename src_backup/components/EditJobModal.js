    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h2 style={{ margin: 0, fontSize: '18px' }}>Edit job application</h2>
        ...
        <label style={labelStyle}>
          Date applied
          <input style={inputStyle} type="date" name="applied_at" value={form.applied_at ? new Date(form.applied_at).toISOString().split('T')[0] : ''} onChange={handleChange} />
        </label>
        <label style={labelStyle}>
          Notes
          <textarea style={{ ...inputStyle, height: '72px', resize: 'vertical' }} name="notes" value={form.notes || ''} onChange={handleChange} placeholder="Any details about this application..." />
        </label>
